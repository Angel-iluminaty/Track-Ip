...
@is_option
def IP_Track():
    ip = input(f"{Wh}\n Ingresar IP a rastrear : {Gr}")  # INPUT IP ADDRESS
    print()
    print(f' {Wh}============= {Gr}MOSTRAR INFORMACIÓN DIRECCIÓN IP {Wh}=============')
...
def phoneGW():
    User_phone = input(
        f"\n {Wh}Ingrese el número de teléfono objetivo {Gr}Ex [+6281xxxxxxxxx] {Wh}: {Gr}")  # INPUT NUMBER PHONE
    ...
    print(f"\n {Wh}========== {Gr}MOSTRAR INFORMACION DE TELÉFONO{Wh}==========")
    ...
    try:
        ...
        for site in social_media:
            ...
            if response.status_code == 200:
                ...
                results[site['name']] = (f"{Ye}Nombre de usuario no encontrado {Ye}!")
...
def showIP():
    ...
    print(f"\n {Wh}========== {Gr}MOSTRAR INFORMACIÓN DE TU IP {Wh}==========")
    print(f"\n {Wh}[{Gr} + {Wh}] Su dirección IP : {Gr}{Show_IP}")
    print(f"\n {Wh}==============================================")
...
options = [
    ...
    {
        'num': 3,
        'text': 'Rastreador de números de teléfono',
        'func': phoneGW
    },
    {
        'num': 4,
        'text': 'Rastreador de nombre de usuario',
        'func': TrackLu
    },
    {
        'num': 0,
...
def run_banner():
    ...
    stderr.writelines(f"""{Wh}
         .-.
       .'   `.          {Wh}--------------------------------
       :g g   :         {Wh}| {Gr}TRACKER - IP ADDRESS {Wh}|
       : o    `.        {Wh}| {Gr}CREADOR: Angel Del Villar      {Wh}|
      :         ``.     {Wh}--------------------------------
     :             `.
    :  :         .   `.
    :   :          ` . `.
...
def main():
    ...
    time.sleep(1)
    try:
        opt = int(input(f"{Wh}\n [ + ] {Gr}Seleccionar opción : {Wh}"))
        execute_option(opt)
    except ValueError:
        print(f'\n{Wh}[ {Re}! {Wh}] {Re}Por favor ingrese el número')
        time.sleep(2)
        main()
